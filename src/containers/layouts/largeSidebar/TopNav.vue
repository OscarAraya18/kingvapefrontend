<template>
  <div class="main-header">
    ...
    <div class="header-part-right">
      ...
      <button @click="updateApplicationStatus()" :class="getApplicationStatusClass()" style="position:relative; left: -10px; font-size: medium;" v-if="(ranking == false) && (agentType == 'admin') && (agentName == 'Rafat J.' || agentName == 'Oscar')"><strong>{{ applicationStatus }}</strong></button>
